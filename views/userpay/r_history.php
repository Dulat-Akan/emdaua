		...
		<div class="col-xs-10" style="margin-left: 0px;padding-left: 0px;">
		  <div  id="home">
					...
					<table class="table table-bordered">
							...
							<tr>
							    <td style="font-size: 12px"> GAME NO </td>
							    <td style="font-size: 12px"> DATE / TIME </td>
							    <td style="font-size: 12px"> INITIAL BALANCE </td>
							    <td style="font-size: 12px"> BET </td>
							    <td style="font-size: 12px"> WINNING NUMBER </td>
							    <td style="font-size: 12px"> COMBINATION </td>
							    <td style="font-size: 12px"> WIN </td>
							    <td style="font-size: 12px"> LAST BALANCE </td>
						...
						?>
								...
								<?php
									    ...
									    <td style="font-size: 12px"><?php if(isset($unserial[7])){ echo $unserial[7];	}  ?> </td>
									    <td style="font-size: 12px"><?php echo $time; ?> </td>
									    <td style="font-size: 12px"><?php  echo $startingbalans;    ?></td>
									    <td style="font-size: 12px"><?php echo $unserial[0][1][$i]; ?></td>
									    <td style="font-size: 12px"><?php echo $unserial[5]; ?></td>
									    <td style="font-size: 12px"><?php echo $a_1." : ".$unserial[0][0][$i]; ?> </td>

										<?php if($unserial[0][3][$i] > 0){ ?>
									    	<td style="color:green;"><b><?php echo $unserial[0][3][$i]; ?></b></td>
										<?php }else{ ?>
										0<td style="font-size: 12px"><?php echo $unserial[0][3][$i]; ?></td>
										<?php } ?>

									    <td style="font-size: 12px"> <?php if(isset($unserial[8])){ echo $unserial[8];	} ?> </td>
									  </tr>
								...
								<?php
								               ...
								               if($fixtime % 2 == 0){
			                                        ...
			                                        <?php               	
	                                                   ...
	                                                   <?php 
													  	...
													  	?> 
											<td style="font-size: 12px"><?php if(isset($unserial[7])){ echo $unserial[7];	}  ?> </td>
											<td style="font-size: 12px"><?php echo date("d.m.y H:i:s",$key['time']); ?> </td>
											<td style="font-size: 12px"><?php  echo $startingbalans3;  ?></td>
											<td style="font-size: 12px"><?php echo $unserial[2][1][$iii]; ?></td>
											<td style="font-size: 12px"><?php echo $unserial[5]; ?></td>
											<td style="font-size: 12px"><?php echo $a_3." : ".$unserial[2][0][$iii]; ?></td>
											...
											<?php }else{ ?>
											<td style="font-size: 12px"><?php echo $unserial[2][3][$iii]; ?></td>
											<?php } ?>
