...
$status =0;
                      ...
                      if($pp<5 && $dd>5&&$dd<8)  // только игроку доп карта
                        $status = 1;
                      if($pp>5 && $pp<8 && $dd<6) // только диллеру доп карта
                        $status = 2;
                      if($pp<6 && $pp<6)
                        $status = 3;
    ...
    <input type="hidden" id="dd" value="<?php echo $dd;?>">
    <input type="hidden" id="pp" value="<?php echo $pp;?>">
    <!-- Tab panes -->
