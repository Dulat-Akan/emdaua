...
<div class="cvet">
    <div class="main-video">
        <div class="videopoker">
            ...
            <img style="user-select: none; cursor: zoom-in;top:2000px;" src="http://192.168.3.150:8092/webcam3.mjpeg" width="100%" height="450px">
        </div>
    </div><!--main-video-->
</div>
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                for(d=0;d<15;d++){
                    ...
                    if(d>12){
                        for(m=0;m<5;m++){
                            //var arr = findstreetflash6(Math.trunc(nn[(m)].ves/10),Math.trunc(nn[(m+5)].ves/10),Math.trunc(nn[10].ves/10),Math.trunc(nn[11].ves/10),Math.trunc(nn[12].ves/10),Math.trunc(nn[13].ves/10));
                            var arr = findstreetflash6(nn[(m)].ves, nn[(m+5)].ves, nn[10].ves, nn[11].ves, nn[12].ves, nn[13].ves);
                            //pair=findstreetflesh(arr[0],arr[1],arr[2],arr[3],arr[4]);
                            console.log(arr);
                            //console.log(pair);
                        }
