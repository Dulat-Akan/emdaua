...
<input id="basesendstopgame" type="hidden" value="<?php echo Url::to('@base'); ?>/site/sendstopgame">
...
<div id="pok_searh2"></div>



<script src="<?php echo Url::to('@jquery') ?>/server_live.js"></script>