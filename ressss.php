...
<div class="col-sm-12" id="winmessage" style="display: none;">
   <div class="col-sm-5 col-sm-offset-3">
      
      <div class="alert alert-info">
           <h3>Вы выиграли подробности см. статистику</h3>
      </div>
         ...
         <div class="col-sm-7 col-sm-offset-2" style="border:2px solid red;z-index: 10;">
               ...
               <div class="y numb" x="0">0<div style="position: absolute;left:20px;top:20px;" count="0" class="i"></div></div>
                  ...
                  <div style="margin-top: 5px;margin-left: 125px;">
                     ...
                     <div id="fish_p">
                        <div><img class="fishki" v="1" style="width: 70px; float: left;" src="<?php echo  Url::to('@img'); ?>/fishki/1.png" alt=""></div>
                        <div><img class="fishki" v="5" style="width: 70px;  float: left;margin-left: 5px;" src="<?php echo  Url::to('@img'); ?>/fishki/5.png" alt=""></div>
                        <div><img class="fishki" v="25" style="width: 70px; float: left;margin-left: 5px;" src="<?php echo  Url::to('@img'); ?>/fishki/25.png" alt=""></div>
                        <div><img class="fishki" v="50" style="width: 70px; float: left;margin-left: 5px;" src="<?php echo  Url::to('@img'); ?>/fishki/50.png" alt=""></div>
                        <div><img class="fishki" v="100" style="width: 70px; float: left;margin-left: 5px;" src="<?php echo  Url::to('@img'); ?>/fishki/100.png" alt=""></div>
                        <div><img class="fishki" v="500" style="width: 70px; float: left;margin-left: 5px;" src="<?php echo  Url::to('@img'); ?>/fishki/500.png" alt=""></div>
                  ...
                  <div style="margin-top: 100px;">
                     ...
                     <div class="n250" style="float: left;">помощь</div>
                     <div class="n251"  style="float: left;">X2 double</div>
                     <div  class="n252" style="float: left;">очистить</div>
                     <div class="n253"  style="float: left;">повторить</div>
